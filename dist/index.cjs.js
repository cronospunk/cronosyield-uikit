...
var PanelFooter = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav, toggleTheme = _a.toggleTheme, isDark = _a.isDark, cakePriceUsd = _a.cakePriceUsd, priceLink = _a.priceLink;
    if (!isPushed) {
...
var AccountModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        ...
        React__default['default'].createElement(Flex, { mb: "32px" },
            React__default['default'].createElement(LinkExternal, { small: true, href: "https://cronos.crypto.org/explorer/address/" + account, mr: "20px" }, "View on Cronos Explorer"),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { cardBorder: "#E7E3EB", backgroundAlt: "#FFFFFF", secondary: "#423E37", background: "#FFFFFF", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#272121", textDisabled: "#BDC2C4", textSubtle: "#423E37", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { backgroundAlt: "#27262c", background: "#272121", cardBorder: "#383241", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#F5CB5C", tertiary: "#353547", text: "#FFFFFF", textDisabled: "#666171", textSubtle: "#FFFFFF", borderColor: "#524B63", card: "#27262c", gradients: {
